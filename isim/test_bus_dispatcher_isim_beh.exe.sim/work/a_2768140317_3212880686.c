...
#endif
static const char *ng0 = "C:/Users/leavan/Desktop/thcomips/bus_dispatcher.vhd";
...
LAB11:    t1 = ((WORK_P_0136478414) + 3208U);
    t6 = *((char **)t1);
    t11 = *((int *)t6);
    if (t9 == t11)
        goto LAB7;

LAB12:    t1 = ((WORK_P_0136478414) + 3328U);
    t7 = *((char **)t1);
    t12 = *((int *)t7);
    if (t9 == t12)
        goto LAB8;

LAB13:    t1 = ((WORK_P_0136478414) + 3448U);
    t8 = *((char **)t1);
    t13 = *((int *)t8);
    if (t9 == t13)
        goto LAB9;
...
{
	static char *pe[] = {(void *)work_a_2768140317_3212880686_p_0,(void *)work_a_2768140317_3212880686_p_1};
